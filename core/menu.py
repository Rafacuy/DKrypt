...
def show_menu():
    menu_options = [
        ...
        ("11", "HTTP Desync Attack Tester", "Find a Smuggling Request on the target website"),
    ...
    menu_content.append("Version 1.2.5 (STABLE) • © 2025 DKrypt Security\n\n", style="italic #6C757D")
    ...
    # footer
    footer = Text("Select option 1-12 • Confirm: ENTER", style="italic #6C757D", justify="center")
    ...
    return console.input("\n[blink bold #EF476F]>>>[/blink bold #EF476F] Select option (1-12): ")
